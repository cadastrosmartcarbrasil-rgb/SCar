      ...
      {isLoading ? (
        ...
        <ul className="space-y-2">
          {lista.map((t) => {
            ...
            return (
              <li key={t.id} className="rounded-2xl border border-slate-200/80 bg-white p-4">
...
function ModalSegundaVia({ titulo, onClose }: { titulo: PortalTitulo; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-40 grid place-items-end bg-slate-900/50 p-0 sm:place-items-center sm:p-4"
      onClick={onClose}>
      <div
          ...
          <div className="mt-4 space-y-2.5">
            ...
            {dados.url_boleto && (
              <a
                ...
                className="flex w-full items-center justify-center gap-1.5 rounded-lg bg-brand-600 px-3 py-2.5 text-[12.5px] font-bold text-white transition hover:bg-brand-700"
              >
