...
import type { DreLinha, DreMes, DreResumo, RegimeDre, ResumoCentroCusto } from '@/lib/database.types';
...
// Receitas x despesas por centro de custo (RPC resumo_por_centro_custo) — 0027.
